                ...
                children: [
                  ...
                  Container(
                    ...
                    child: const Column(
                      ...
                      children: [
                        Text('32 Hz', style: TextStyle(fontSize: 8, fontWeight: FontWeight.bold, color: AppColors.primaryGold)),
                        Text('26 Hz', style: TextStyle(fontSize: 8, fontWeight: FontWeight.bold, color: AppColors.primaryGold)),
                        Text('20 Hz', style: TextStyle(fontSize: 8, fontWeight: FontWeight.bold, color: AppColors.primaryGold)),
                        Text('14 Hz', style: TextStyle(fontSize: 8, fontWeight: FontWeight.bold, color: AppColors.primaryGold)),
                        Text('7.8 Hz', style: TextStyle(fontSize: 8, fontWeight: FontWeight.bold, color: AppColors.primaryGold)),
                      ],
                    ),
                  ),
